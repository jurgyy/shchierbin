...
function crusher_animation_horizontal_main()
  return util.sprite_load("__shchierbin__/graphics/entity/crusher/crusher-horizontal",
  {
    animation_speed = 0.5,
    frame_count = 48,
    scale = 0.5,
...
function crusher_animation_vertical_main()
  return util.sprite_load("__shchierbin__/graphics/entity/crusher/crusher-vertical",
  {
    animation_speed = 0.5,
    frame_count = 48,
    scale = 0.5,
